...
const projects = [
  ...
  },
  {
    ...
    description: 'Designed a full stack Gamin smartwatch analytics dashboard within a Docker container. Data is pulled via API, stored in SQL databases and then input into a React frontend using local APIs.s',
    image: '/dashboard.png',
